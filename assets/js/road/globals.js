...
var maxWidth=Math.max(2000,Math.min(window.innerWidth,window.innerHeight)-50);

var outerRadius = (maxWidth / 2),
    innerRadius = outerRadius - 350,//调整周围字的显示
    monthWidth=Math.max(400,(innerRadius*2)-50);
...
d3.select(document.getElementById("bpg"))
    .style("min-width",(outerRadius*2 + 1050) + "px");
...
var svg = d3.select(document.getElementById("svgDiv"))
    ...
    .style("height", (outerRadius*2+3200) + "px")
    .append("svg")
    .attr("id","svg")
    .style("width", (outerRadius*2) + "px")
    .style("height", (outerRadius*2+3200) + "px");
